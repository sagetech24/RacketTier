...
**Baseline:** `6 / 5 / 4` (tuned for RacketTier dark kinetic sports brand). Use these unless the design read overrides them. Do not ask the user to edit this file - overrides happen conversationally.

> **RacketTier note:** This skill is for **marketing/landing** (`/`) only. App dashboards and queueing UI must follow `DESIGN.md` and `.cursor/skills/rackettier-ui-craft/SKILL.md` instead.
